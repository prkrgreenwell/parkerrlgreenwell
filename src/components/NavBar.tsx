...
import { GitHub, LinkedIn, Menu, Close, Email } from "@mui/icons-material";
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Image src="/../../../assets/sig.png" alt="/" width="125" height="50" />
        <div>
          ...
          <div onClick={handleNav} className="md:hidden cursor-pointer">
            <Menu style={{ color: linkColor }} fontSize="large" />
          </div>
        </div>
      </div>
